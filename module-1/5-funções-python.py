...
print(most_and_least_frequent("alice29.txt"))
...
def histogram(file): 
  ...
  print("________________________HISTOGRAM________________________")
  for key in frequencies:
    ...
    print("{key}: {frequency}".format(key=key,frequency=frequency))
