...
from exercise1aiii import hamming_code_bsc_correction_mode, count_bits_through_BSC
...
print()
for error_rate in error_rates:
    BER = hamming_code_bsc_correction_mode(file, error_rate)
    different_symbols = count_different_symbols(file, error_rate)
    print("p:", error_rate)
    print("BER:", BER)
    print("Number of different symbols:", different_symbols)
