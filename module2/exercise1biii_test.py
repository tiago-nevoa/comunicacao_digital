...
from exercise1biii import BER_hamming_code_bsc_correction_mode, count_bits_through_BSC, count_different_symbols

error_rates = [10**-1, 10**-2, 10**-3, 10**-4, 10**-5]
input_files = ["TestFilesCD/alice29.txt", "TestFilesCD/progc.c"]
interleaving_output_file = "hamming_interleaving_output.txt"
...
for file in input_files:
    ...
    for error_rate in error_rates:
        BER = BER_hamming_code_bsc_correction_mode(interleaving_output_file, error_rate, rows, columns)
